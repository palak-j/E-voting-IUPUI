...
<button class = "button" ><a href="manage_pos.php">Manage Positions</a></button>
<button class = "button" ><a href="manage_cand.php">Manage Candidates</a></button>
<button class = "button" ><a href="results.php">Poll Results</a></button>
</div>
